...
| 3 | RLS ownership verification | Verify cross-user isolation on all 3 tables, including the new DELETE policies | #5 | Postgres/RLS-level | change opened | `context/changes/testing-rls-ownership-verification/` |

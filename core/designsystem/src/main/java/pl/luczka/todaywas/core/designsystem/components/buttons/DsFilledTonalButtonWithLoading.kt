...
@Composable
fun DsFilledTonalButtonWithLoading(
    text: String,
    onClick: () -> Unit,
...
private class DsFilledTonalButtonWithLoadingPreviewStateProvider :
...
@PreviewLightDark
@Composable
private fun DsFilledTonalButtonWithLoadingPreview(
    @PreviewParameter(DsFilledTonalButtonWithLoadingPreviewStateProvider::class)
